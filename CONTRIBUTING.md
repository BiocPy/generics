...
Welcome to `bioc-generics` contributor's guide.
...
If you experience bugs or general issues with `bioc-generics`, please have a look
...
You can help improve `bioc-generics` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`bioc-generics` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `bioc-generics`'s files. While this mechanism can
...
```
conda create -n bioc-generics python=3 six virtualenv pytest pytest-cov
conda activate bioc-generics
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/bioc-generics.git
   cd bioc-generics
   ```
...
5. Install [pre-commit]:
   ...
   `bioc-generics` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/bioc-generics
[issue tracker]: https://github.com/<USERNAME>/bioc-generics/issues
